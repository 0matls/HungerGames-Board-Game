...
public class Board {
    ...
    */
    ...
    public Board(Board board){
        ...
        this.weapons = board.weapons.clone();
        this.food = board.food.clone();
        this.traps = board.traps.clone();
        
        this.weaponAreaLimits = board.weaponAreaLimits.clone();
        this.trapAreaLimits = board.trapAreaLimits.clone();
        this.foodAreaLimits = board.foodAreaLimits.clone();
    }
    ...
    public void createRandomWeapon() {
        ...
        for(i = 0; i < W; i++) {
            ...
            for(int j = 0; j < W; j++) {
            	System.out.println("x =" + weapons[i].getX() + "\ny =" +weapons[i].getY());
            }
    ...
    public void createBoard(graphics g) {
        ...
        //this is for weapon graphics
        int a;
        for(a = 0; a < W; a++) 
            graphics.placeWeapon(weapons[a].getX(),weapons[a].getY(),g,weapons[a]);
        
        
        
        //this iws for food graphics
        int c;
        for(c = 0; c < F; c++) {
        	if(c%3 == 0)
    			graphics.placePeach(food[c].getX(),food[c].getY(),g,this);
    		if(c%3 == 1)
        		graphics.placePineApple(food[c].getX(),food[c].getY(),g,this);
    		if(c%3 == 2)
        		graphics.placeFruit(food[c].getX(),food[c].getY(),g,this);
        }
     ...
     * @param g
     */
    public void resizeBoard(Player player1 ,Player player2,graphics g) {
